      ...
      <div>
        <div className="breadcrumbs ">
          <div className="container">
            <h1 className="pull-left">{detail.title || detail.sno}</h1>
            <ul className="pull-right breadcrumb">
              ...
              {params.type === 'proceedings' && <li><Link to={`/frontend/${params.name}/others/council`}>議會訊息</Link></li>}
              <li>訊息內容</li>
            </ul>
          </div>
        </div>
        <div className="container content">
          <div className="row-fluid privacy">
            {params.type === 'proceedings' ?
              detail.abstract : <div dangerouslySetInnerHTML={{__html: detail.content}} />
            }
          </div>
        </div>
      </div>
